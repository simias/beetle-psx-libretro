...
extern void dynasm_emit_rfe(struct dynarec_compiler *compiler);
...
extern void dynasm_emit_ori(struct dynarec_compiler *compiler,
                            ...
                            enum PSX_REG reg_s,
                            uint32_t val);
extern void dynasm_emit_xori(struct dynarec_compiler *compiler,
                            enum PSX_REG reg_t,
                            enum PSX_REG reg_s,
                            uint32_t val);
...
extern void dynasm_emit_sw_noalign(struct dynarec_compiler *compiler,
                                   enum PSX_REG reg_addr,
                                   int16_t offset,
                                   enum PSX_REG reg_val);
extern void dynasm_emit_swl_noalign(struct dynarec_compiler *compiler,
                                   enum PSX_REG reg_addr,
                                   int16_t offset,
                                   enum PSX_REG reg_val);
...
extern void dynasm_emit_lw(struct dynarec_compiler *compiler,
                           ...
                           int16_t offset,
                           enum PSX_REG reg_addr);
extern void dynasm_emit_lw_noalign(struct dynarec_compiler *compiler,
                                   enum PSX_REG reg_target,
                                   int16_t offset,
                                   enum PSX_REG reg_addr);
